...
const Thirdsmallitem = (props) => {
  ...
  return (
    <div className="item3">
    <div className="bigItem3Img"><a href="#" className='expandImg' onClick={(e)=>{clickedProduct(product.name, product.price, product.trailerUrl )}}><img src={product.photo1} alt=""/></a></div>
